...
post1 = Post.create(title: "Canned goods", details: "300 cans of beans", start_at: "", end_at: "", supplier_id: user1.id, location_id: location1.id)
post2 = Post.create(title: "Fresh produce", details: "12 lbs of arugula", start_at: "", end_at: "", supplier_id: user2.id, location_id: location2.id)
post3 = Post.create(title: "Catering leftovers", details: "3 trays of mashed potatoes and 2 trays of brisket", start_at: "", end_at: "", supplier_id: user5.id, location_id: location6.id)
post4 = Post.create(title: "Misc. grocieries", details: "18 boxes of spaghetti", start_at: "", end_at: "", supplier_id: user1.id, location_id: location1.id)
