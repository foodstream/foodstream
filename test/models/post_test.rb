...
class PostTest < ActiveSupport::TestCase
  test "post belongs to a supplier" do
    ...
    post = Post.create!(title: "Produce from Weaverstreet", details: "Fruits and veggies", supplier_id: supplier1.id, start_at: "2013-11-22 2:35PM", end_at: "2013-11-26 2:35PM")
